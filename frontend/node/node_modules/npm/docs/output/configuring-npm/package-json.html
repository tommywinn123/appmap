...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#directorieslib">directories.lib</a></li>
                    <li><a href="#directoriesbin">directories.bin</a></li>
                    <li><a href="#directoriesman">directories.man</a></li>
                    <li><a href="#directoriesdoc">directories.doc</a></li>
                    <li><a href="#directoriesexample">directories.example</a></li>
                    <li><a href="#directoriestest">directories.test</a></li>
                </ul>
                ...
                <li><a href="#enginestrict">engineStrict</a></li>
                <li><a href="#os">os</a></li>
                <li><a href="#cpu">cpu</a></li>
                <li><a href="#preferglobal">preferGlobal</a></li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <ul>
            ...
            <li>The names of scoped packages can begin with a dot or an underscore. This is not permitted without a
                scope.
            </li>
...
"funding": [
  ...
  "http://example.com/donateAlso",
  {
    ...
    "url" : "https://www.patreon.com/my-account"
        ...
        <p><code>README</code>, <code>CHANGES</code>, <code>LICENSE</code> &amp; <code>NOTICE</code> can have any case
            and extension.</p>
...
, "config" : { "port" : "8080" } }
        ...
        <p>See <a href="../using-npm/config.html"><code>config</code></a> and <a href="../using-npm/scripts.html"><code>scripts</code></a>
            for more on package
            configs.</p>
        ...
        <ul>
            ...
            <li><code>&lt;=version</code></li>
            <li><code>~version</code> “Approximately equivalent to version” See <a href="../using-npm/semver.html">semver</a>
            </li>
  ...
  "dependencies": {
    "bar": "file:../foo/bar"
        ...
        <p>These things will be installed when doing <code>npm link</code> or <code>npm install</code>
            ...
            configuration param. See <a href="../using-npm/config.html"><code>config</code></a> for more on the topic.
        </p>
...
└── tea@2.2.0
        ...
        <p>When a user installs your package, npm will emit warnings if packages specified in
            <code>peerDependencies</code> are not already installed. The <code>peerDependenciesMeta</code> field serves
            to provide npm more information on how your peer dependencies are to be used. Specifically, it allows peer
  ...
  "peerDependenciesMeta": {
    "soy-milk": {
      "optional": true
        ...
        <p>Marking a peer dependency as optional ensures npm will not emit a warning if the <code>soy-milk</code>
            package is not installed on the host. This allows you to integrate and interact with a variety of host
            packages without requiring all of them to be installed.</p>
