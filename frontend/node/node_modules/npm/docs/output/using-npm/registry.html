...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#can-i-run-my-own-private-registry">Can I run my own private registry?</a></li>
                <li><a href="#i-dont-want-my-package-published-in-the-official-registry-its-private">I don’t want my
                    package published in the official registry. It’s private.</a></li>
                <li><a href="#will-you-replicate-from-my-registry-into-the-public-one">Will you replicate from my
                    registry into the public one?</a></li>
                <li><a href="#do-i-have-to-use-couchdb-to-build-a-registry-that-npm-can-talk-to">Do I have to use
                    couchdb to build a registry that npm can talk to?</a></li>
                <li><a href="#is-there-a-website-or-something-to-see-package-docs-and-such">Is there a website or
                    something to see package docs and such?</a></li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <p>The npm public registry is powered by a CouchDB database,
            ...
            <a href="https://skimdb.npmjs.com/registry">https://skimdb.npmjs.com/registry</a>. The code for the couchapp
            is
        ...
        <h3 id="will-you-replicate-from-my-registry-into-the-public-one">Will you replicate from my registry into the
            public one?</h3>
        ...
        <h3 id="is-there-a-website-or-something-to-see-package-docs-and-such">Is there a website or something to see
            package docs and such?</h3>
