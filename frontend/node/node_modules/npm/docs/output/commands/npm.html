...
<section id="content">
    ...
    <div id="_content"><h3 id="synopsis">Synopsis</h3>
        ...
        <p>Use <code>npm install blerg</code> to install the latest version of “blerg”. Check out
            <a href="../commands/npm-install.html"><code>npm install</code></a> for more info. It can do a lot of stuff.
        </p>
        ...
        <p>See <a href="../configuring-npm/folders.html"><code>folders</code></a> to learn about where npm puts stuff.
        </p>
        ...
        <ul>
            <li>json:
                Make a package.json file. See <a
                        href="../configuring-npm/package-json.html"><code>package.json</code></a>.
            </li>
            <li>link:
