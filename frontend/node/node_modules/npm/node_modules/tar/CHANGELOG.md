...
- Support `@file.tar` as an entry argument to copy entries from one tar file to another.
- Add `noPax` option
...
- Entirely new API surface, `tar.c()`, `tar.x()` etc., much closer to system tar semantics
