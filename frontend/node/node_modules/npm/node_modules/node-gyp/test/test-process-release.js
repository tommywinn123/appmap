...
test('test process release - process.release ~ node@12.8.0 Windows ARM64', function (t) {
    ...
    t.deepEqual(release, {
        ...
        versionDir: '12.8.0',
        ia32: {
            libUrl: 'https://unofficial-builds.nodejs.org/download/release/v12.8.0/win-x86/node.lib',
            libPath: 'win-x86/node.lib'
        },
        x64: {
            libUrl: 'https://unofficial-builds.nodejs.org/download/release/v12.8.0/win-x64/node.lib',
            libPath: 'win-x64/node.lib'
        },
        arm64: {
            libUrl: 'https://unofficial-builds.nodejs.org/download/release/v12.8.0/win-arm64/node.lib',
            libPath: 'win-arm64/node.lib'
        }
    })
})
...
test('test process release - process.release ~ frankenstein@4.1.23', function (t) {
    ...
    t.deepEqual(release, {
        ...
        ia32: {
            libUrl: 'https://frankensteinjs.org/dist/v4.1.23/win-x86/frankenstein.lib',
            libPath: 'win-x86/frankenstein.lib'
        },
        x64: {
            libUrl: 'https://frankensteinjs.org/dist/v4.1.23/win-x64/frankenstein.lib',
            libPath: 'win-x64/frankenstein.lib'
        },
        arm64: {
            libUrl: 'https://frankensteinjs.org/dist/v4.1.23/win-arm64/frankenstein.lib',
            libPath: 'win-arm64/frankenstein.lib'
        }
    })
})
