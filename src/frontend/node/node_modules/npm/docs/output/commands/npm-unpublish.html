...
<section id="content">
    ...
    <div id="_content"><h3 id="synopsis">Synopsis</h3>
        ...
        <p>Consider using the <code>deprecate</code> command instead, if your intent is to encourage users to upgrade,
            or if you no longer want to maintain a package.</p>
        ...
        <p>Even if a package version is unpublished, that specific name and
            ...
            package again, a new version number must be used. If you unpublish the entire package, you may not publish
            any new versions of that package until 24 hours have passed.</p>
        <p>To learn more about how unpublish is treated on the npm registry, see our <!-- raw HTML omitted --> unpublish
