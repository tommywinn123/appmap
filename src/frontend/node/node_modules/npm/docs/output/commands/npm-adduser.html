...
aliases: login, add-user
        ...
        <p>The base URL of the npm package registry. If <code>scope</code> is also specified,
            ...
            to the scope of the project directory you’re currently in, if any. See <a
                    href="../using-npm/scope.html"><code>scope</code></a>.</p>
        <h4 id="scope">scope</h4>
        <p>Default: none</p>
        <p>If specified, the user and login credentials given will be associated
            with the specified scope. See <a href="../using-npm/scope.html"><code>scope</code></a>. You can use both at
            the same time,
            e.g.</p>
        ...
        <p>This will ensure that all requests to that registry (including for tarballs)
            ...
            different hostnames. See <code>always-auth</code> in <a href="../using-npm/config.html"><code>config</code></a>
            for more details on always-auth. Registry-specific configuration of <code>always-auth</code> takes
