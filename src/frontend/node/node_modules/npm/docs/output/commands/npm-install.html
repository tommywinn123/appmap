    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#configuration-options-affecting-dependency-resolution-and-tree-design">Configuration
                        Options Affecting Dependency Resolution And Tree Design</a></li>
                    <li><a href="#omitting-dependency-types">Omitting Dependency Types</a></li>
                    <li><a href="#configuration-options-affecting-build-process">Configuration Options Affecting Build
                        Process</a></li>
                </ul>
...
npm install gitlab:myusr/myproj#semver:^5.0
        ...
        <h4 id="configuration-options-affecting-dependency-resolution-and-tree-design">Configuration Options Affecting
            Dependency Resolution And Tree Design</h4>
        <ul>
            <li>
