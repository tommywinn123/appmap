...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#using-locked-packages">Using locked packages</a></li>
                    <li><a href="#resolving-lockfile-conflicts">Resolving lockfile conflicts</a></li>
                </ul>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        <p>Conceptually, the “input” to <a href="../commands/npm-install.html"><code>npm install</code></a> is a <a
                href="../configuring-npm/package-json.html">package.json</a>, while its
        ...
        <ul>
            <li>
                <p>different versions of npm (or other package managers) may have been used to install a package, each
                    using slightly different installation algorithms.</p>
            </li>
            <li>
                <p>a new version of a direct semver-range package may have been published since the last time your
                    packages were installed, and thus a newer version will be used.</p>
            </li>
            <li>
                <p>A dependency of one of your dependencies may have published a new version, which will update even if
                    you used pinned dependency specifiers (<code>1.2.3</code> instead of <code>^1.2.3</code>)</p>
            </li>
            <li>
                <p>The registry you installed from is no longer available, or allows mutation of versions (unlike the
                    primary npm registry), and a different version of a package exists under the same version number
                    now.</p>
            </li>
        </ul>
...
`-- B@0.0.2
    `-- C@0.0.1
        ...
        <p>To prevent this potential issue, npm uses <a href="../configuring-npm/package-lock-json.html">package-lock.json</a>
            or, if present, <a href="../configuring-npm/shrinkwrap-json.html">npm-shrinkwrap.json</a>. These files are
            called package locks, or lockfiles.</p>
  ...
  "dependencies": {
    ...
    "postshrinkwrap": "json -I -e \"this.myMetadata = $MY_APP_METADATA\""
        ...
        <p>Using a locked package is no different than using any package without a package
            ...
            dependencies will automatically sync the existing lockfile. This includes <code>npm install</code>, <code>npm
                rm</code>, <code>npm update</code>, etc. To prevent this update from happening,
        ...
        <p>To make this process seamless on git, consider installing
            ...
            to do this itself without any user interaction. In short: <code>$ npx npm-merge-driver install -g</code>
