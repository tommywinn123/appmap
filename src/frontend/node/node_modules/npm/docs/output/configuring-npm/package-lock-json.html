...
<section id="content">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="#lockfileversion">lockfileVersion</a></li>
                    <li><a href="#packageintegrity">packageIntegrity</a></li>
                    ...
                    <ul>
                        ...
                        <li><a href="#bundled">bundled</a></li>
                        <li><a href="#dev">dev</a></li>
                        <li><a href="#optional">optional</a></li>
                        <li><a href="#requires">requires</a></li>
                        <li><a href="#dependencies2">dependencies</a></li>
                    </ul>
                </ul>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <ul>
            <li>
                <p>Describe a single representation of a dependency tree such that teammates, deployments, and
                    continuous integration are guaranteed to install exactly the same dependencies.</p>
            </li>
            <li>
        ...
        <p>One key detail about <code>package-lock.json</code> is that it cannot be published, and it
            ...
            a format with <a href="../configuring-npm/shrinkwrap-json.html">npm-shrinkwrap.json</a>, which is
            essentially the same file, but
        ...
        <ul>
            ...
            <li>git sources: This is a git specifier with resolved committish. (eg, <code>git+https://example.com/foo/bar#115311855adb0789a0466714ed48a1499ffea97e</code>)
            </li>
            <li>http tarball sources: This is the URL of the tarball. (eg,
                <code>https://example.com/example-1.3.0.tgz</code>)
            </li>
            <li>local tarball sources: This is the file URL of the tarball. (eg <code>file:///opt/storage/example-1.3.0.tgz</code>)
            </li>
        ...
        <ul>
            ...
            <li>For registry sources, this is the <code>integrity</code> that the registry provided, or if one wasn’t
                provided the SHA1 in <code>shasum</code>.
            </li>
