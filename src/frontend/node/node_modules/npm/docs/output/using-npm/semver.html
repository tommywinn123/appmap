    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    <li><a href="#prerelease-tags">Prerelease Tags</a></li>
                    <ul>
                        <li><a href="#prerelease-identifiers">Prerelease Identifiers</a></li>
                    </ul>
                    <li><a href="#advanced-range-syntax">Advanced Range Syntax</a></li>
                    <ul>
                        <li><a href="#hyphen-ranges-xyz---abc">Hyphen Ranges <code>X.Y.Z - A.B.C</code></a></li>
                        <li><a href="#x-ranges-12x-1x-12-">X-Ranges <code>1.2.x</code> <code>1.X</code>
                            <code>1.2.*</code> <code>*</code></a></li>
                        <li><a href="#tilde-ranges-123-12-1">Tilde Ranges <code>~1.2.3</code> <code>~1.2</code>
                            <code>~1</code></a></li>
                        <li><a href="#caret-ranges-123-025-004">Caret Ranges <code>^1.2.3</code> <code>^0.2.5</code>
                            <code>^0.0.4</code></a></li>
                    </ul>
                    <li><a href="#range-grammar">Range Grammar</a></li>
                </ul>
                <li><a href="#functions">Functions</a></li>
                <ul>
                    <li><a href="#comparison">Comparison</a></li>
                    <li><a href="#comparators">Comparators</a></li>
                    <li><a href="#ranges2">Ranges</a></li>
...
multiple versions to the utility will just sort them.
        ...
        <p>For example, the comparator <code>&gt;=1.2.7</code> would match the versions
            <code>1.2.7</code>, <code>1.2.8</code>, <code>2.5.3</code>, and <code>1.3.9</code>, but not the versions
            <code>1.2.6</code>
        ...
        <p>For example, the range <code>&gt;=1.2.7 &lt;1.3.0</code> would match the versions
            <code>1.2.7</code>, <code>1.2.8</code>, and <code>1.2.99</code>, but not the versions <code>1.2.6</code>,
            <code>1.3.0</code>,
            or <code>1.1.0</code>.</p>
...
part       ::= nr | [-0-9A-Za-z]+
        ...
        <ul>
            ...
            <li><code>diff(v1, v2)</code>: Returns difference between two versions by the release type
                (<code>major</code>, <code>premajor</code>, <code>minor</code>, <code>preminor</code>,
                <code>patch</code>, <code>prepatch</code>, or <code>prerelease</code>),
        ...
        <ul>
            ...
            <li><code>outside(version, range, hilo)</code>: Return true if the version is outside
                ...
                <code>hilo</code> argument must be either the string <code>'&gt;'</code> or <code>'&lt;'</code>. (This
                is
