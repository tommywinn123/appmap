...
A ShellString represents a shell command after it has been interpolated, but before it has been formatted for a
...
The special characters ``# $ & ( ) ; < > \ ` |``, if unquoted, form their own words.
